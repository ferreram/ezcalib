...
public:
  ...
  void displayParamsWithStd() const override
  {
    ...
    std::cout << "\n Distortion k4 / k5 / k6 : " << m_k4 << " / " << m_k5 << " / " << m_k6 << " +/- " << m_vdist_params_std[3] << " / " << m_vdist_params_std[4] << " / " << m_vdist_params_std[5];
    std::cout << "\n Distortion p1 / p2 : " << m_p1 << " / " << m_p2 << " +/- " << m_vdist_params_std[6] << " / " << m_vdist_params_std[7] << "\n\n";
  }
