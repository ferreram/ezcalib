...
private:
  ...
  class ReprojectionError : public ceres::SizedCostFunction<2, 2, 2, 3, 7>
  {
  public:
                  ...
                  double **jacobians) const
    {
      ...
      if (jacobians != nullptr)
      {
        ...
        {
          Eigen::Map<Eigen::Matrix<double, 2, 3, Eigen::RowMajor>> J_dist(jacobians[2]);
        ...
        if (jacobians[3] != nullptr)
        {
          ...
          const double dr6_dx = 6.*x*r4;
          const double dr6_dy = 6.*y*r4;

          J_cam_dist << D + x * (dr2_dx*k1 + dr4_dx*k2 + dr6_dx*k3),     x * (dr2_dy*k1 + dr4_dy*k2 + dr6_dy*k3),
                            y * (dr2_dx*k1 + dr4_dx*k2 + dr6_dx*k3), D + y * (dr2_dy*k1 + dr4_dy*k2 + dr6_dy*k3);
